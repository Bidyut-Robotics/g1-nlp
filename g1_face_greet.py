...
# ZMQ Sockets
ZMQ_VIDEO_URL = f"tcp://{G1_IP}:5555"
ZMQ_TTS_URL = f"tcp://{G1_IP}:5556"
...
<body>
    <div class="header">
        ...
        <div class="status-badge">System Active (ZMQ Distributed)</div>
    </div>
    <div class="dashboard">
...
def zmq_receiver_worker():
    ...
    socket.connect(ZMQ_VIDEO_URL)
    socket.setsockopt_string(zmq.SUBSCRIBE, "")
    log.info(f"Connected to G1 ZMQ Camera Stream at {ZMQ_VIDEO_URL}")
